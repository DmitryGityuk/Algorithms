...
public class ModifiedShellSort {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(array) + " - KnuthStep");
        shellSort(array, new ShellStep(array));
        System.out.println(Arrays.toString(array) + " - ShellStep");
        shellSort(array, new SedgewickStep(array));
        System.out.println(Arrays.toString(array) + " - SedgewickStep");
        shellSort(array, new HibbardStep(array));
        System.out.println(Arrays.toString(array) + " - HibbardStep");
        ...
        Utils.measureTime(() -> shellSort(arr3, new SedgewickStep(array)), "SedgewickStep");
        Utils.measureTime(() -> shellSort(arr4, new HibbardStep(array)), "HibbardStep");
